...
root.iconbitmap(r"C:\Users\yjosh\Downloads\Dtafalonso-Android-Lollipop-Calculator (1).ico")

e = Entry(root, font="timesnewroman 18 bold" ,bg='grey')
e.grid(row = 0, column= 0, columnspan=4)
l1 = Label(root, text = "Equal: ")
...
button_clear = Button(root, text="X", padx=50, pady=20, command=button_clear )
